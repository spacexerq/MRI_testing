...
def calc_lims(): 
    ...
    t_sps = param.spoil_strenght/(param.sl_thkn*hw.G_amp_max) + hw.tau_max   # Длительность сс спойлерного градиента, который в конце
    t_spf = param.spoil_strenght*param.Nf/(param.FoV_f*hw.G_amp_max) + hw.tau_max  # Длительность спойлерного градиента по направлению фазового код-ия
